...
class Toast {
  ...
  // 背景颜色
  static Color _bgColor = Colors.black;
  // 文本颜色
  static Color _textColor = Colors.white;
  // 文字大小
  static double _textSize = 14.0;
  // 显示位置
  static ToastPostion _toastPosition = ToastPostion.center;
  // 左右边距
  static double _pdHorizontal = 20.0;
  // 上下边距
  static double _pdVertical = 10.0;
  static void toast(
    ...
    //2秒后 到底消失不消失
    if (_startedTime != null && DateTime.now().difference(_startedTime!).inMilliseconds >= _showTime) {
      _showing = false;
      _overlayEntry?.markNeedsBuild();
